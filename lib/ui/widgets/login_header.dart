...
import 'package:flutter_provider_demo/ui/shared/text_styles.dart';
import 'package:flutter_provider_demo/ui/shared/ui_helpers.dart';
...
class LoginHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(children: <Widget>[
      ...
      Text('Enter your name', style: subHeaderStyle),
